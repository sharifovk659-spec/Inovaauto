...
/** Резервная навигация кабинета (если cabinet-nav.php не загружен на сервер). */
...
<nav class="<?= ia_h($navClass) ?>" aria-label="Кабинет продавца">
    ...
    <a class="ia-cabinet-nav-link active" href="<?= ia_h($profileActiveUrl) ?>"><i class="bi bi-car-front" aria-hidden="true"></i><span>Мои объявления</span></a>
    ...
    <a class="ia-cabinet-nav-link" href="<?= ia_h(ia_public_url('messages.php')) ?>"><i class="bi bi-chat-dots" aria-hidden="true"></i><span>Сообщения</span><?php if ($iaCabinetChatUnread > 0): ?><em class="ia-cabinet-nav-badge"><?= (int) $iaCabinetChatUnread ?></em><?php endif; ?></a>
    <a class="ia-cabinet-nav-link" href="<?= ia_h(ia_public_url('notifications.php')) ?>"><i class="bi bi-bell" aria-hidden="true"></i><span>Уведомления</span><?php if ($iaCabinetNotifUnread > 0): ?><em class="ia-cabinet-nav-badge"><?= (int) $iaCabinetNotifUnread ?></em><?php endif; ?></a>
