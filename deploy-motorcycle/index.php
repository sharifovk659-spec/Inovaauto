...
<section class="py-4 ia-page-section ia-why-section">
    <div class="container ia-container">
        <h2 class="h5 text-secondary text-uppercase letter-spacing mb-3 ia-why-section-title">Почему InnovaAuto</h2>
        <div class="row g-3 ia-why-grid">
            <div class="col-md-4">
                <article class="ia-why-card">
                    <h3 class="h6 mb-2">Безопасно</h3>
                    <p class="small text-secondary mb-0">Проверка объявлений, модерация контента и защищенные сессии пользователей.</p>
                </article>
            </div>
            <div class="col-md-4">
                <article class="ia-why-card">
                    <h3 class="h6 mb-2">Быстро</h3>
                    <p class="small text-secondary mb-0">Удобный поиск по бренду, модели, цене и году с быстрым откликом.</p>
                </article>
            </div>
            <div class="col-md-4">
                <article class="ia-why-card">
                    <h3 class="h6 mb-2">Легко</h3>
                    <p class="small text-secondary mb-0">Размещение объявления за несколько минут и переписка с покупателями в чате.</p>
                </article>
            </div>
        </div>
    </div>
